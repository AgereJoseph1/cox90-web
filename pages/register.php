					...
					<div  class="white-popup log-in-popup">
						<div class="login-form">
							...
							<div class="title-section">
								<h1><b style='color:#e74769'>Cox90</b><br><span>Register</span></h1>
							</div>
							...
							<p class="btn rd-stroke-btn center-block register-line"><a class='logintext' style='cursor: pointer; text-decoration: none; display: block;'>Login</a></p>
							</div>
						...
						<div id="register_footer">
							...
							<p class="register-line">Back to <a style='color: #ee2b63; font-weight: 500; font-size: 1.2em; text-decoration: none; cursor: pointer'>Login</a></p>
						</div>
						</div>
...
<div class="lost-password-form">
	...
	<p class="register-line">Back to <a  style='cursor: pointer' >Login</a></p>
</div>
						...
						<div id="login_footer">
							...
							<p class="login-line">Don't have account. <a style='color: #ee2b63; font-weight: 500; font-size: 1.2em; text-decoration: none; cursor: pointer'>Register</a></p>
